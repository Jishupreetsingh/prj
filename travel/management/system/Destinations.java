...
public class Destinations extends JFrame implements Runnable {
   ...
   // JLabel caption;
    ...
    public void run() {
        String[] text = new String[]{"JW Marriot Hotel","Madarin Oriental Hotel","Four Seasons Hotel","Raddisson Blue Hotel","Classsio Hotel","The Bay CLub Hotel","Breeze Blow Hotel","Taj Hotel","Happy Morning Motel","River View Hotel"};
        try{
            for(int i = 0;i<9;i++){
